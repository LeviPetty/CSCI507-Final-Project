...
img1_path = 'Z:/Computer Vision/Final-Project/Card Images';
img2_path = 'Z:/Computer Vision/Final-Project/Kingdoms';
vlsift_path = 'Z:/Computer Vision';
% -------------------------------------------------------------------------
...
disp('Please select folder containing card image files');
baseDir = uigetdir;
baseFiles = dir(fullfile(baseDir, '*.jpg'));

disp('Please select folder containing comparison image files');
compDir = uigetdir;
